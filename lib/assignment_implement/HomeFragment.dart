...
class _HomefragmentState extends State<Homefragment> {
  ...
  void addContact() {
    ...
    if (number.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Please Enter Your Valid Number')),
      );
      return;
    }
    if (!phoneRegex.hasMatch(number)) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(
            'Invalid phone number! Must be 11 digits and start with 01[3-9]')),
      );
      return;
    }
    setState(() {
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        cursorColor: MyColors.green,
                        validator: (value) {
                          if (value == null || !RegExp(r'^01[3-9][0-9]{8}$')
                              .hasMatch(value)) {
                            return 'Enter a Valid 11-digit number startin with 01[3-9]';
                          }
                          return null;
                        },
                      ),
                        ...
                        children: [
                          Container(
                            ...
                            child: ListTile(
                              ...
                              trailing: Icon(
                                Icons.phone, color: MyColors.blue,),
